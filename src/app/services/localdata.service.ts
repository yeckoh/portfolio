  ...
  */
  ...
  CNU = {
    ...
    { name: "Software Design/Development",
      code: "CPSC 480",
      description: "Using and contributing to FOSS and HFOSS projects. Software development lifecycles. Projects using the LAMP stack. ++Contributed to SugarLabs’s MusicBlocks git repository" },
